...
##/////////////////////////////////////////////////////////////////////////////////
## Creation of "Energy sub metering" as function of time plot
##////////////////////////////////////////////////////////////////////////////////

plot(data$dmy_hms, data$Sub_metering_1, ylab = "Energy sub metering",
     xlab = "", type = "l" )
lines(data$dmy_hms,data$Sub_metering_2, col = "orangered" )
lines(data$dmy_hms,data$Sub_metering_3, col = "blue" )
legend("topright", col = c("black","orangered", "blue"), 
       legend = c("Sub metering 1", "Sub metering 2", "Sub metering 2"), lty = 1, lwd=2,
       cex=0.6)

## copy the picture in the file
