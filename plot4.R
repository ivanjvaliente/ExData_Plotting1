...
##/////////////////////////////////////////////////////////////////////////////////
## Creation of Multiple  plots in a picture  (Global Active Power+
## voltage as function of time)
##/////////////////////////////////////////////////////////////////////////////////

par(mfrow = c(2,2), mar=c(4,4,2,1), oma=c(0,0,2,0))
with(data, {
    plot(dmy_hms, Global_active_power, ylab = "Global Active Power (kilowatts)",
         xlab = "", type = "l" )
    
    plot(dmy_hms, Voltage, ylab = "Voltage", xlab = "datetime", type = "l" )
    
    plot(dmy_hms, Sub_metering_1, ylab = "Energy sub metering",
         xlab = "", type = "l" )
    lines(dmy_hms, Sub_metering_2, col = "orangered" )
    lines(dmy_hms, Sub_metering_3, col = "blue" )
    legend("topright", col = c("black","orangered", "blue"), 
           legend = c("Sub metering 1", "Sub metering 2", "Sub metering 2"), lty = 1, 
           lwd = 2, bty="n", cex = 0.45)
    
    plot(dmy_hms, Global_reactive_power,  xlab = "datetime", type = "l" )
    
})

## coping the picture in the file
